...
const processor = function (page, subscription, payload) {
  this.page = page;
...
processor.prototype.mount = function (methods) {
  if (typeof methods == 'object') {
      ...
      this[methods[i]] = function (method) {
        ...
        if (i == methods.length - 1) {
          this.page.$store.dispatch('requestCustomer', {
            ...
            page: this,
            payload: { ...this.payload, ...this.pool },
          });
        }
        return this;
      }
    ...
    this[methods] = function (method) {
      this.pool[methods] = method;
      this.page.$store.dispatch('requestCustomer', {
        request: this.subscription,
        page: this,
        payload: { ...this.pool, ...this.payload }
      });
      return this;
    }
  }
...
register.install = function (Vue, options) {
  ...
  Vue.prototype.$processor = function (subscription, payload) {
    return new processor(this, subscription, payload);
  }
}
